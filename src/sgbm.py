...
if __name__ == "__main__":
    ...
    left_disparity_map = process_stereo_images(left_name=left_name , right_name= right_name , evaluation=False , type = "kitti")

    # run this for teddy
    # left_name="../data/teddy/im2.png"
    # right_name="../data/teddy/im6.png"
    # left_gt_name='../data/teddy/disp2.png'
    # right_gt_name='../data/teddy/disp6.png',


    left_disparity_map = process_stereo_images(left_name=left_name , right_name= right_name , evaluation=True , type = "teddy")
